                                  ...
                                  {[
                                    {
                                      ...
                                      desc: "Strategic management that ensures timely and successful project delivery.",
                                    },
                                    {
                                      title: "Agile and Scrum project management",
                                      desc: "Flexible, iterative approach that accelerates development and collaboration..",
                                    },
                                    {
                                      title: "Digital transformation strategy",
                                      desc: "Modernize systems and processes with tailored transformation roadmaps.",
                                    },
                                    {
                                      title: "Process automation consulting",
                                      desc: "Optimize operations through intelligent workflow automation.",
                                    },
